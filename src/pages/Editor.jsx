    ...
    <div className="flex flex-col h-screen bg-[#0f0f0f] overflow-hidden select-none">
      ...
      <nav className="flex items-center justify-between px-4 py-2.5 bg-[#0a0a0a] border-b border-[#1f1f1f] shrink-0 h-[52px]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="bg-[#1f1008] border border-[#e87040] border-opacity-50 rounded px-2.5 py-1 ml-1">
      ...
      <div className={`${previewHeightClass} w-full bg-black flex items-center justify-center shrink-0 relative transition-[height] duration-300`}>
        ...
        >
          ...
          {clips.length === 0 ? (
            ...
            <div className="w-10 h-10 rounded-full border border-white border-opacity-15 bg-white bg-opacity-5 flex items-center justify-center">
      ...
      >
        ...
        {errorMsg && (
          <div className="mx-3.5 mt-3 px-3 py-2 rounded-lg bg-[#2a0808] border border-[#e87040] border-opacity-40">
      ...
      <div className="flex flex-col justify-center px-2 min-w-0 pointer-events-none">
        ...
        <div className="flex items-center gap-1 mt-0.5">
          ...
          {clip.speed && clip.speed !== 1 && (
            <span className="text-[8px] text-[#e87040] bg-[#e87040] bg-opacity-20 px-1 rounded">
              {clip.speed}×
            </span>
          )}
...
function ActionBtn({ label, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex-1 bg-[#2a1508] border border-[#e87040] border-opacity-60 text-[#e87040] text-[10px] font-bold py-2.5 rounded-lg hover:opacity-90 active:opacity-75 transition-opacity"
    >
      {label}
    </button>
  )
  ...
  return (
    <div
      ...
      className={`h-9 rounded-md border flex items-center overflow-hidden relative select-none
        ${isSelected ? 'border-white border-opacity-90 cursor-grabbing' : 'border-[#4a8c5c] border-opacity-70 cursor-grab'}`}
  ...
  return (
    <div
      ...
      className={`rounded-md border flex items-center overflow-hidden relative select-none ${isSelected
          ? 'border-white border-opacity-90 cursor-grabbing'
          : overlay.type === 'video'
            ? 'border-[#5a7c9e] border-opacity-70 cursor-grab'
            : 'border-[#7c5a9e] border-opacity-70 cursor-grab'
        }`}
      onPointerDown={handlePointerDown}
      onPointerMove={handlePointerMove}
      onPointerUp={handlePointerUp}
  ...
  return (
    <div
      ...
      className={`rounded-md border flex items-center overflow-hidden relative select-none
        ${isSelected ? 'border-white border-opacity-90 cursor-grabbing' : 'border-[#8c7a20] border-opacity-70 cursor-grab'}`}
      onPointerDown={handlePointerDown}
      onPointerMove={handlePointerMove}
      onPointerUp={handlePointerUp}
      onClick={(e) => e.stopPropagation()}
